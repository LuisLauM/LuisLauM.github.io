...
# Breakpoints tomados el 2026-02-11 desde:
# https://siofen.imarpe.gob.pe/nivel2/indice-costero-el-nino-icen
refICEN <- list(breaks = c(-Inf, -1.3, -1.1, -.7, 0.5, 1.3, 2.1, 3.5, Inf),
                labels = c(paste("La Ni\u00f1a", c("Fuerte", "Moderada", "Débil")), 
                           "Neutro", 
                           paste("El Ni\u00f1o", c("Débil", "Moderado", "Fuerte", "Extraordinario"))))
...
El Índice Costero El Niño (ICEN) es un índice oficial utilizado por el ENFEN para monitorear El Niño y La Niña frente a la costa del Perú. Se calcula como la media corrida de tres meses de la anomalía de la temperatura superficial del mar en la región Niño 1+2. Este índice se diferencia de otros usados internacionalmente en que refleja mejor las condiciones de la costa peruana. Los puntos de corte para la categorización de la intensidad fueron tomados desde la web del [SIOFEN-IMARPE](https://siofen.imarpe.gob.pe/nivel2/indice-costero-el-nino-icen).
