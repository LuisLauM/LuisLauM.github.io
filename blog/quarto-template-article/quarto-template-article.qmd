...
* Quarto: En los últimos años, RStudio ya incluye una versión reciente de Quarto, pero si usted desea probar versiones preliminare, puede descargarlas desde <https://quarto.org/docs/download/index.html>.
...
* Integración Zotero-Quarto-RStudio: Para insertar citas bibliográficas, se recomienda seguir los pasos de [mi post anterior]().
