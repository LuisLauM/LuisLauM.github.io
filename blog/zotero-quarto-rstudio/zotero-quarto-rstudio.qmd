...
::: callout-note
All the material needed to run this tutorial can be found in my repository, following this link [link](https://github.com/LuisLauM/LuisLauM.github.io/tree/main/blog/zotero-quarto-rstudio/test-rbbt).
:::
...
::: callout-note
Todo el material necesario para ejecutar este tutorial se puede encontrar en mi repositorio, siguiendo este [link](https://github.com/LuisLauM/LuisLauM.github.io/tree/main/blog/zotero-quarto-rstudio/test-rbbt).
:::
